...
// =====================
app.put('/:id', [ mdAutnticacion.verificarToken, mdAutnticacion.verificarADMINoSiMismo ], (req, res) => {
...
// ========================
app.delete('/:id', [ mdAutnticacion.verificarToken, mdAutnticacion.verificarADMIN_ROLE ], (req, res) => {
